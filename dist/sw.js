const CACHE = "seb-navigator-v29";
const ASSETS = ["./", "./auth.html", "./index.html", "./overview.html", "./sales.html", "./assets/shared.css", "./assets/core.js", "./assets/commission.js", "./assets/auth.js", "./assets/catalog.js", "./assets/overview.js", "./assets/sales.js", "./assets/xlsx.full.min.js", "./assets/jszip.min.js", "./data/catalog.json", "./data/commission-template.xlsx", "./manifest.webmanifest", "./icons/icon-180.png", "./icons/icon-192.png", "./icons/icon-512.png"];
