const CACHE = "seb-navigator-v37";
const ASSETS = ["./", "./auth", "./overview", "./sales", "./assets/shared.css", "./assets/core.js", "./assets/commission.js", "./assets/auth.js", "./assets/catalog.js", "./assets/overview.js", "./assets/sales.js", "./assets/xlsx.full.min.js", "./assets/jszip.min.js", "./data/idx-7f2ae1.bin", "./data/commission-template.xlsx", "./manifest.webmanifest", "./icons/icon-180.png", "./icons/icon-192.png", "./icons/icon-512.png"];
const PROTECTED = ["/data/idx-7f2ae1.bin", "/data/commission-template.xlsx"];
